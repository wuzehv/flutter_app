...
class FfmBuild extends StatefulWidget {
  final JenkinsShipla jenkins;
  final List<String> approver;
  final Map<String, Map<String, bool>> params;

  const FfmBuild({super.key, required this.jenkins, required this.approver, required this.params});

  @override
  State<StatefulWidget> createState() => _ShiplaBuildState();
}

class _ShiplaBuildState extends State<FfmBuild> {
