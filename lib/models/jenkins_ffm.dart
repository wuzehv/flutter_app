...
class JenkinsFfm extends JenkinsProjectModel {
  final BuildContext context;
  final JenkinsModel jenkins;

  JenkinsFfm(this.context, this.jenkins, {required super.name});
  ...
  Future<void> _toBuildPage() async {
    ...
    try {
      ...
      Map<String, Map<String, bool>> paramsM = {
        ...
        'projects': {'wms-scm-api': false, 'wms-new-api': false, 'wms-boss-api': false},
      };
      switch (name) {
        case ffmGo:
          paramsM['projects'] = {
      ...
      context.push('/job/project/ffm_build', extra: {'obj': this, 'params': paramsM, 'approver': a});
    } catch (e) {
